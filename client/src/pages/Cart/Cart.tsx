...
export default function Cart() {
  ...
  useEffect(() => {
    ...
    if (!token && cartItems.length > 0) {
      localStorage.setItem(
        process.env.REACT_APP_CART_KEY || "guess_cart",
  ...
  return (
    <div className="cart-full-container w-100 h-100 d-flex flex-column justify-content-center align-items-center">
      <div className="cart-container h-100">
        <div className="container cart-list-container">
          <span className="list-label text-start mb-2">
        ...
        {userData && (
          <div className="cart-list-container d-flex flex-column justify-content-start align-items-center">
            <div className="d-flex w-100 px-2 align-items-center mb-3">
              ...
              <span
                className="btn btn-outline-dark ms-auto fw-bolder"
                onClick={() => {
                  navigate("/order");
                }}
              >
                Xem Toàn BỘ <i className="pi pi-arrow-up-right"></i>
              </span>
            </div>
            {userData && (
      ...
      <div className="w-100 bg-dark">
        ...
        <span className="w-100 text-white">
          AUTHOR: HAIHV(cjjjjjk) - cart-page
        </span>
      </div>
    </div>
  );
