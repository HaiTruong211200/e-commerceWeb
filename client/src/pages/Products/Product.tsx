...
const Product: React.FC = function () {
  ...
  const handlerAddToCart = function () {
    const cartItem: CartItem = {
      ...
      price:
        productInfo.priceMap?.[
          Object.keys(productInfo.priceMap || {})[activeSizeIndex]
        ],
      quantity: count,
  ...
  return (
    <div className="product-full-container position-relative left-0 h-100 w-100 d-flex flex-column justify-content-start align-items-center">
      <div className="product-container">
        <div className="container-images">
          {productInfo.images?.slice(0, 4).map((url: string, index: number) => (
        ...
        <div className="container-content d-flex gap-1 flex-column justify-content-start align-items-start">
          <div className="product-info">
            ...
            <p>
              <strong>Đánh giá:</strong> {productInfo.ratingsAverage} ⭐ (
              {productInfo.ratingsCount} đánh giá)
            </p>
            <p>
              <strong>Sẵn hàng:</strong>{" "}
              {(Object.values(productInfo.stockMap || {}) as number[])[
                activeSizeIndex
              ] || 0}{" "}
              sản phẩm
            </p>
            <p>
              ...
              {(Object.values(productInfo.soldMap || {}) as number[])[
                activeSizeIndex
              ] || 0}{" "}
              sản phẩm
            </p>
          ...
          <div className="product-control d-flex justify-content-center align-items-center gap-3">
            ...
            <button
              ...
              className={`btn product-btn btn-wishlist pi ${
                isWishlist ? "pi-heart-fill" : "pi-heart"
              }`}
            ></button>
          </div>
        </div>
      ...
      <div className="all-images-container">
        {productInfo.images?.slice(0, 10).map((url: string, index: number) => (
          <img key={index} src={url} alt={`Product Image ${index + 1}`} />
        ))}
      </div>
      <hr />
      ...
      <div className="product-review-container d-flex flex-column justify-content-start align-items-center">
        {Array.isArray(productInfo.reviews) &&
                  ...
                  <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                      <div className="d-flex align-items-center gap-2">
                        ...
                        <h6 className="mb-0 text-dark fw-bolder">
                          {displayName}
                        </h6>
                      </div>
      ...
      {/* <div className="w-100 bg-dark">
        ...
        <span className="w-100 text-white">
          AUTHOR: HAIHV(cjjjjjk) - PRODUCT PAGE: {productId}
        </span>
      </div> */}
    </div>
  );
